...
$offers_launch_json_path = "${repo_root}\eszop-backend\Offers\Offers.API\Properties\launchSettings.json"
...
$offers_appsettings_path = "${repo_root}\eszop-backend\Offers\Offers.API\appsettings.DevHostLocal.json"
